...
class InternalReferenceBeanBuilder
extends AbstractAnnotationConfigBeanBuilder<Reference, ReferenceBean> {
    private InternalReferenceBeanBuilder(Reference annotation, ClassLoader classLoader, ApplicationContext applicationContext) {
    ...
    public static InternalReferenceBeanBuilder create(Reference annotation, ClassLoader classLoader, ApplicationContext applicationContext) {
        return new InternalReferenceBeanBuilder(annotation, classLoader, applicationContext);
    }
}
