...
public class Constants {
    ...
    public static final String REGISTER_EXCLUDE_KEY = "exclude";
    ...
    public static final String DEFAULT_TETHER_REMOTING_SERVER = "tether";
    public static final String DEFAULT_TETHER_REMOTING_CLIENT = "tether";
    public static final String DEFAULT_TETHER_PROTOCOL_NAME = "tether";
    ...
    public static final String INJECTOR_FACTORY_KEY = "injector.factory";
    ...
    public static final String GENERIC_REGISTER_KEY = "generic.register";
    ...
    public static final String INVOCATION_SKIP_ROUTE = "invocation.skip.route";
    ...
    public static final String GENERIC_SERIALIZATION_RESULT_NO_CHANGE = "result_no_change";
    public static final String GENERIC_JSON_RESULT = "json";
    public static final String BACKLOG_KEY = "backlog";
    public static final int DEFAULT_BACKLOG = 512;
    public static final String REST_SERVER_HANDLER_THREAD_POOL_NAME = "RestServerHandler";
    ...
    public static final String SERVICE_CHAIN_NAME = "name";
    public static final String SERVICE_CHAIN_ZAN_TEST = "zan_test";
    ...
    public static final String DATACENTER_KEY = "dc";
    public static final String ENABLE_DATACENTER_KEY = "dc.enable";
    ...
    public static final int MAX_HTTP_CONTENT_BYTES = 16384;
    ...
    public static final String HTTP2_METHOD_KEY = ":service.method";
    public static final String HTTP2_PATH_KEY = ":path";
    ...
    public static final String HTTP2_RPC_TIMEOUT_KEY = "rpc-timeout";
    ...
    public static final String HTTP2_DUBBO_CONTENT_TYPE = "application/dubbo+hessian";
    public static final String HTTP2_DUBBO_RPC_STATUS = "rpc-status";
    public static final String HTTP2_DUBBO_RPC_MESSAGE = "rpc-message";
    public static final String HTTP2_DUBBO_RPC_HOTST = "rpc-host";
    ...
    public static final String HEARTBEAT_PATH = "/_HB_";
    public static final String GET_KEY = "GET";
    public static final String TOTAL_KEY = "total";
    public static final String FROM_APP_KEY = "from_app";
    public static final String EPOLL_ENABLE = "epoll";
    public static final String CLOSE_CACHE_KEY = "registry.cache.close";
}
